...
import model_dir
import trainer
from data_processing.qa_training_data import ContextLenKey, ContextLenBucketedKey, DocumentQaTrainingData
...
def main():
    ...
    train_params = TrainParams(SerializableOptimizer("Adadelta", dict(learning_rate=1)),
    ...
    model = Attention(
        ...
        word_embed=DropNames(vec_name="glove.840B.300d", selector=NameDetector(),
                             word_vec_init_scale=0, learn_unk=False, keep_probs=0.6, kind="shuffle"),
