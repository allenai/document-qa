...
from nn.span_prediction import ConfidencePredictor, BoundsPredictor, WithFixedContextPredictionLayer, \
    BoundedSpanPredictor, SpanFromVectorBound
...
def main():
    ...
    model = Attention(
        encoder=DocumentAndQuestionEncoder(PackedMultiSpanAnswerEncoder(10)),
        ...
        predictor=BoundsPredictor(
            ...
            span_predictor=BoundedSpanPredictor(10, aggregate="sum"),
        )
    )
