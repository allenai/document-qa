...
from nn.attention import StaticAttention, StaticAttentionSelf, BiAttention, AttentionEncoder
...
from nn.layers import NullBiMapper, SequenceMapperSeq, FullyConnectedMerge, DropoutLayer, ChainBiMapper, \
    ConcatWithProduct, FullyConnected, ResidualLayer, WithProjectedProduct, MapperSeq, HighwayLayer
...
def main():
    ...
    model = Attention(
        ...
        match_encoder=SequenceMapperSeq(
            ...
            ResidualLayer(BiRecurrentMapper(GruCellSpec(100))),
            DropoutLayer(dropout),
