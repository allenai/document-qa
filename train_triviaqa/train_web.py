...
from data_processing.multi_paragraph_qa import RandomParagraphDatasetBuilder, StratifiedParagraphSetDatasetBuilder, \
    StratifyParagraphsBuilder
from data_processing.preprocessed_corpus import PreprocessedData
from data_processing.qa_training_data import ParagraphAndQuestionDatasetBuilder, ContextLenKey, ContextLenBucketedKey
...
def main():
    ...
    eval_builder = RandomParagraphDatasetBuilder(eval_batching, eval_batching, 0.5, 2)
