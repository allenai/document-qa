...
from paragraph_selection.paragraph_selection_featurizer import ExtractedParagraphWithAnswers, NGramMatchingFeaturizer
...
class TestSelectionFeatures(unittest.TestCase):
    ...
    def test_matching_features(self):
        ...
        features = fe.get_joint_features(
            ...
            [[ExtractedParagraphWithAnswers(x, 0, 0, None) for x in [
                [["the", "fox"]],
                [["the", "fox"], ["the", "dog"]],
                [["Where", "cat"], ["bill", "dogs"]],
                [["bill", "dog"], ["Pen", "dogs"]]
